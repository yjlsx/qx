...
^https?:\/\/api\.m\.jd\.com\/client\.action\?functionId=orderDetail url script-response-body https://raw.githubusercontent.com/yjlsx/qx/refs/heads/main/jd2.js


# 2. 兼容旧的URL匹配方式 (如果需要)
^https?:\/\/api\.m\.jd\.com\/client\.action\?t=\d+&loginType=2&loginWQBiz=golden-trade&appid=m_core&client=iPhone&clientVersion=&build url script-response-body https://raw.githubusercontent.com/yjlsx/qx/refs/heads/main/jd2.js
...
const DETAIL_NEW_ORDER_ID = "343598145710"; // 详情页显示的新订单号

const DETAIL_NEW_DATE_BASE = "2025-11-16";  // 新的日期
const DETAIL_NEW_TIME_BASE = "09:30:10";   // 新的基本时间 (用于下单时间)
const DETAIL_NEW_PAY_TIME = "2025-11-16 09:31:32"; // 新的支付时间
const DETAIL_NEW_COMPLETE_TIME = "2025-11-16 10:02:04"; // 新的订单完成/送达时间
const DETAIL_NEW_EXPECTED_DELIVERY_TIME = "2025-11-16 10:00-10:15"; // 新的期望配送时间
const DETAIL_NEW_CURRENT_TIME = "2025-11-16 09:32:12"; // 模拟服务器返回的当前时间
