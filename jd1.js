...
const DETAIL_NEW_ORDER_ID = "327040181864"; // 详情页显示的新订单号

const DETAIL_NEW_DATE_BASE = "2025-12-02";  // 新的日期
const DETAIL_NEW_TIME_BASE = "09:47:27";   // 新的基本时间 (用于下单时间)
const DETAIL_NEW_PAY_TIME = "2025-12-02 09:48:21"; // 新的支付时间
const DETAIL_NEW_COMPLETE_TIME = "2025-12-02 10:24:11"; // 新的订单完成/送达时间
const DETAIL_NEW_EXPECTED_DELIVERY_TIME = "2025-12-02 10:20-10:35"; // 新的期望配送时间
const DETAIL_NEW_CURRENT_TIME = "2025-12-02 09:49:26"; // 模拟服务器返回的当前时间
