...
const DETAIL_NEW_ORDER_ID = "323758371825"; // 详情页显示的新订单号

const DETAIL_NEW_DATE_BASE = "2025-11-19";  // 新的日期
const DETAIL_NEW_TIME_BASE = "09:12:18";   // 新的基本时间 (用于下单时间)
const DETAIL_NEW_PAY_TIME = "2025-11-19 09:13:55"; // 新的支付时间
const DETAIL_NEW_COMPLETE_TIME = "2025-11-19 09:47:04"; // 新的订单完成/送达时间
const DETAIL_NEW_EXPECTED_DELIVERY_TIME = "2025-11-19 09:48-10:03"; // 新的期望配送时间
const DETAIL_NEW_CURRENT_TIME = "2025-11-19 09:14:28"; // 模拟服务器返回的当前时间
