...
const DETAIL_NEW_ORDER_ID = "3338254108477641"; // 详情页显示的新订单号

const DETAIL_NEW_DATE_BASE = "2025-12-07";  // 新的日期
const DETAIL_NEW_TIME_BASE = "17:10:47";   // 新的基本时间 (用于下单时间)
const DETAIL_NEW_PAY_TIME = "2025-12-07 17:11:37"; // 新的支付时间
const DETAIL_NEW_COMPLETE_TIME = "2025-12-07 17:56:37"; // 新的订单完成/送达时间
const DETAIL_NEW_EXPECTED_DELIVERY_TIME = "2025-12-07 17:55-18:05"; // 新的期望配送时间
const DETAIL_NEW_CURRENT_TIME = "2025-12-07 17:12:06"; // 模拟服务器返回的当前时间
