...
const DETAIL_NEW_ORDER_ID = "327022615481"; // 详情页显示的新订单号

const DETAIL_NEW_DATE_BASE = "2025-11-26";  // 新的日期
const DETAIL_NEW_TIME_BASE = "11:45:12";   // 新的基本时间 (用于下单时间)
const DETAIL_NEW_PAY_TIME = "2025-11-26 11:47:05"; // 新的支付时间
const DETAIL_NEW_COMPLETE_TIME = "2025-11-26 12:34:19"; // 新的订单完成/送达时间
const DETAIL_NEW_EXPECTED_DELIVERY_TIME = "2025-11-26 12:30-12:40"; // 新的期望配送时间
const DETAIL_NEW_CURRENT_TIME = "2025-11-26 11:48:29"; // 模拟服务器返回的当前时间
