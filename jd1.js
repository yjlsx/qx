...
const DETAIL_NEW_ORDER_ID = "327042582547"; // 详情页显示的新订单号

const DETAIL_NEW_DATE_BASE = "2025-12-02";  // 新的日期
const DETAIL_NEW_TIME_BASE = "10:08:13";   // 新的基本时间 (用于下单时间)
const DETAIL_NEW_PAY_TIME = "2025-12-02 10:09:36"; // 新的支付时间
const DETAIL_NEW_COMPLETE_TIME = "2025-12-02 10:45:54"; // 新的订单完成/送达时间
const DETAIL_NEW_EXPECTED_DELIVERY_TIME = "2025-12-02 10:45-11:00"; // 新的期望配送时间
const DETAIL_NEW_CURRENT_TIME = "2025-12-02 10:10:01"; // 模拟服务器返回的当前时间
