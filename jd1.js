...
const DETAIL_NEW_ORDER_ID = "360941456544"; // 详情页显示的新订单编号

const DETAIL_NEW_DATE_BASE = "2025-11-08";  // 新的日期
const DETAIL_NEW_TIME_BASE = "10:01:20";   // 新的基本时间 (用于下单时间)
const DETAIL_NEW_PAY_TIME = "2025-11-08 10:01:55"; // 新的支付时间
const DETAIL_NEW_COMPLETE_TIME = "2025-11-08 11:01:04"; // 新的订单完成/送达时间
const DETAIL_NEW_EXPECTED_DELIVERY_TIME = "2025-11-08 10:30-11:00"; // 新的期望配送时间
const DETAIL_NEW_CURRENT_TIME = "2025-11-08 10:03:47"; // 模拟服务器返回的当前时间
