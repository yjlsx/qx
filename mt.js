...
// === 🧭 你只要改这里 ===
const CUSTOM_ORDER_TIME = "2025-11-15 09:42:24"; // 🕐 下单时间（精确到秒）
const TARGET_ORDER_ID_NUM = "601863551823514172";   // 新订单号6018四位
const TARGET_ARRIVAL_TIME = "11月15日 10:15-10:30"; // 期望送达时间
// =====================
