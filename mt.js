...
// === 🧭 你只要改这里 ===
const CUSTOM_ORDER_TIME = "2026-01-17 09:27:39";    // 🕐 下单时间（精确到秒）
const TARGET_ORDER_ID_NUM = "6019535709277563421"; // 订单号（详情页显示）
const TARGET_ARRIVAL_TIME = "01月17日09:58-10:08"; // 送达时间
// =====================
