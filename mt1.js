...
// === 统一配置区域 ===
const CUSTOM_ORDER_TIME = "2026-03-22 10:01:20";   
const TARGET_ORDER_ID_NUM = 602046841826517617; 
const TARGET_ORDER_ID_STR = "602046841826517617"; 
const TARGET_ARRIVAL_TIME = "03月22日 10:54-11:09"; 
const CUSTOM_POI_NAME = "鮨念.精致料理.刺身.寿司.生腌（正义坊店）";  //鮨念.精致料理.刺身.寿司.生腌（正义坊店）
// ==================================
